...
if __name__ == "__main__":
    ...
    while endInput != "end":
        ...
        if endInput == '1':
            ...
            test.mqtt_client.myPublish("/Turin/notifications/u2", json.dumps(payload))
        elif endInput == '5':
            ...
            test.mqtt_client.myPublish("/Turin/notifications/u3", json.dumps(payload))
        else:
            payload = {"invalid": True}
            test.mqtt_client.myPublish("/Turin/notifications/", json.dumps(payload)) 
